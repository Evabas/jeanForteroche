...
<body>
     ...
     ?>
        ...
        <h2>
              ...
              <?php echo $donnees['contenu']; ?>
                <br />
                <button type="reset" class="btn btn-danger mb-2">Supprimer</button>
              </p>
        <?php
        }
    }
    ...
    <h2> Modération des commentaires </h2>
        ...
        <h3><?php  if (isset($comment)){echo $comment['pseudo'];} ?> </h3>
            
            <p>
                <?php if (isset($comment)){echo $comment['commentaire'];} ?>
            </p>
            <button type="reset" class="btn btn-danger mb-2">Supprimer</button>
